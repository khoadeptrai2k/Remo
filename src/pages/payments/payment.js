...
for(let i=0;i<14;i++) {
    USERS[i] = {
        ...
        startDate: faker.date.past().toLocaleDateString('en-US'),
        endDate: faker.date.past().toLocaleDateString('en-US'),
      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell className={classes.tableHeaderCell}>DATE START</TableCell>
            <TableCell className={classes.tableHeaderCell}>DATE END</TableCell>
        ...
        <TableBody>
          {USERS.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => (
            <TableRow key={row.name}>
                ...
                <TableCell>
                  <Typography color="textSecondary" variant="body2">{row.amount}</Typography>
                </TableCell>
